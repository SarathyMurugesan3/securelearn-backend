	...
	public SecurityFilterChain filterChain(
		...
		http
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers("/api/admin/users/**").hasAnyAuthority("ADMIN", "TUTOR")
						.requestMatchers("/api/admin/manage-users/**").hasAnyAuthority("ADMIN", "TUTOR")
						.requestMatchers("/api/admin/content/**").hasAnyAuthority("ADMIN", "TUTOR")
						.requestMatchers("/api/admin/manage-content/**").hasAnyAuthority("ADMIN", "TUTOR")
