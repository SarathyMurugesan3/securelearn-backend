	...
	public SecurityFilterChain filterChain(
		...
		http
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers("/api/super-admin/**").hasAnyAuthority("SUPER_ADMIN", "ROLE_SUPER_ADMIN")
						.requestMatchers("/api/auth/admin/**").hasAnyAuthority("ADMIN", "ROLE_ADMIN")
						.requestMatchers("/actuator/**").permitAll()
						.requestMatchers("/api/admin/users/**").hasAnyAuthority("ADMIN", "ROLE_ADMIN", "TUTOR", "ROLE_TUTOR", "SUPER_ADMIN", "ROLE_SUPER_ADMIN")
						.requestMatchers("/api/admin/manage-users/**").hasAnyAuthority("ADMIN", "ROLE_ADMIN", "TUTOR", "ROLE_TUTOR", "SUPER_ADMIN", "ROLE_SUPER_ADMIN")
						.requestMatchers("/api/admin/content/**").hasAnyAuthority("ADMIN", "ROLE_ADMIN", "TUTOR", "ROLE_TUTOR", "SUPER_ADMIN", "ROLE_SUPER_ADMIN")
						.requestMatchers("/api/admin/manage-content/**").hasAnyAuthority("ADMIN", "ROLE_ADMIN", "TUTOR", "ROLE_TUTOR", "SUPER_ADMIN", "ROLE_SUPER_ADMIN")
						...
						.requestMatchers("/api/tutor/**").hasAnyAuthority("TUTOR", "ROLE_TUTOR", "ADMIN", "ROLE_ADMIN", "SUPER_ADMIN", "ROLE_SUPER_ADMIN")
						...
						.requestMatchers("/api/student/**").hasAnyAuthority("STUDENT", "ROLE_STUDENT", "ADMIN", "ROLE_ADMIN", "TUTOR", "ROLE_TUTOR")
