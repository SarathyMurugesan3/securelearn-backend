...
public class PdfWatermarkService {
    ...
    /**
     * Watermark raw byte array input (e.g. downloaded from Cloudinary)
     */
    public byte[] addWatermarkFromBytes(byte[] pdfBytes, String line1, String line2) throws IOException {
